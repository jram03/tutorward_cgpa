...
<body>
    ...
    <a href="/tutor_cgpa/tutor_cgpa/dashboard2.php?name=<?php echo $_GET["name"] ?>"><button id="sem3" onclick="sem_2()">Sem 2</button></a>
        <button id="sem3" onclick="sem_3()">Sem 3</button>
    ...
    <div id="sampp">
        <table id="samptt">
            ...
            <?php 
                ...
                ?>
            <form method="post" action="/tutor_cgpa/tutor_cgpa/dashboard3.php?name=<?php echo $_GET["name"] ?>&sem=sem3">
            ...
            //     //  $sql1= "UPDATE sem3 set 19SH11C= $_POST[$k] where name=".$_GET["name"];

            //     //  mysqli_query($conn,$sql1);
            //  }
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                foreach ($arr2 as $k => $v){
                    $sql1="UPDATE sem3 set $k=".$_POST[$k]." where reg_no=\"".$_GET['name']."\"";
            ...
            // $sql1="UPDATE sem3 set 19SH11C=".$_POST["19SH11C"].",19SH12C=".$_POST["19SH12C"]." ,19SH13C=".$_POST["19SH13C"]." ,19SH14C=".$_POST["19SH14C"]." ,19CS11C=".$_POST["19CS11C"]." ,19CS12C=".$_POST["19CS12C"]." ,19SH16C=".$_POST["19SH16C"]." ,19CS13C=".$_POST["19CS13C"]." where name=\"".$_GET['name']."\"";
            ...
            if($tot1!=0)
                 ...
                 $sql = "UPDATE sem3 SET gpa='$gpa' where reg_no='".$_GET["name"]."' ";
                 mysqli_query($conn, $sql);
